...
class BurgerBuilder extends Component {
  ...
  componentDidMount () {
    axios.get("https://react-my-burger-8d607.firebaseio.com/ingredients.json")
      .then(response => {
  ...
  render() {
    ...
    // changes the values of disabledInfo to true or false based on conditional to disable buttons
